(function ($) {
	...
	$(".acordion1 a").click(function() {
		...
		$('.content_accordion_7').removeClass('open');
		$('.acordion7 a').removeClass('open');
		$('.content_accordion_8').removeClass('open');
		$('.acordion8 a').removeClass('open');
	});
	
	$(".content_accordion_1 .close-button").click(function() {
		$(".content_accordion_1").toggleClass("open");
		$(".content_accordion").toggleClass("open");
		$(".acordion1 a").toggleClass("open");
	});
	...
	$(".acordion8 a").click(function() {
		...
		$('.content_accordion_7').removeClass('open');
		$('.acordion7 a').removeClass('open');
		$('.content_accordion_8').toggleClass('open');
		$('.acordion8 a').toggleClass('open');
	});
	
	$(".content_accordion_8 .close-button").click(function() {
		$(".content_accordion_8").toggleClass("open");
		$(".content_accordion").toggleClass("open");
		$(".acordion8 a").toggleClass("open");
	});
